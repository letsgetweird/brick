...
def refresh_data():
    ...
    if asset_count_display[0]:
        asset_count_display[0].text = f'{asset_count} device{"s" if asset_count != 1 else ""} found'
...
with ui.column().classes('w-full max-w-6xl mx-auto p-6 gap-6'):
    ...
    # Export section
    components.create_export_section(asset_count_display)
